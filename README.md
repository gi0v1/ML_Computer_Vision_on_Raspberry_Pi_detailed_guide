...
If you want to perform real-time object detection, you'll likely need a camera, I would recomend the Raspberry Pi Camera Module 3 (please note that depending on your application the Wide version might come handy) for its image quality and ease of use.
